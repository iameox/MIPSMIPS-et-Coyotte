...
#define INS_POINTERS {&translate_add, &translate_addi, &translate_and, &translate_beq, &translate_bgtz, &translate_blez, &translate_bne, &translate_div, &translate_j, &translate_jal, &translate_jr, &translate_lui, &translate_lw, &translate_mfhi, &translate_mflo, &translate_mult, &translate_nop, &translate_or, &translate_rotr, &translate_sll, &translate_slt, &translate_srl, &translate_sub, &translate_sw, &translate_xor}
